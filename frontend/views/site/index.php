...
$this->title = 'Салон красоты Елена';


?>
<!-- Swiper-->
<section class="section swiper-container swiper-slider swiper-slider-1" data-loop="false" data-autoplay="10000" data-simulate-touch="false" data-slide-effect="fade">
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-10 col-lg-8 col-xl-7">
              <h1 class="heading-decorate" data-caption-animate="fadeInUp" data-caption-delay="100"><span class="text-primary">Елена </span>салон красоты<br><span class="divider linedecor"></span>Красота это Дар
              </h1>
              <p class="lead coment" data-caption-animate="fadeInUp" data-caption-delay="250">Салон красоты Елена предлагает самые современные и качественные услуги для Вас и всех членов Вашей семьи.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-lg-8 col-xl-7">
              <h1 class="heading-decorate" data-caption-animate="fadeInUp" data-caption-delay="100"><span class="text-primary">ESTEL</span> профессиональная косметика<br><span class="divider linedecor"></span>только самое лучшее для Вас
              </h1>
              <p class="lead coment" data-caption-animate="fadeInUp" data-caption-delay="250">Мы предлагаем полный спектр парикмахерских услуг для мужчин и женщин, уход за бровями и ресницами.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="swiper-slide" data-slide-bg="images/slide-3-1920x720.jpg">
      <div class="swiper-slide-caption section-md">
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-lg-8 col-xl-7">
              <h1 class="heading-decorate" data-caption-animate="fadeInUp" data-caption-delay="100">Наши <span class="text-primary">лучшие мастера</span> <br><span class="divider linedecor"></span>исполнят ваши мечты
              </h1>
              <p class="lead coment" data-caption-animate="fadeInUp" data-caption-delay="250">В салоне красоты Елена Вы можете насладиться преимуществами профессионального ухода по доступной цене.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row row-50 align-items-lg-center justify-content-xl-between">
      ...
      <div class="col-lg-6 col-xl-5">
        <h2 class="heading-decorate">Наши клиенты <br><span class="divider"></span>Они выбрали нас
        </h2>
        <p class="big text-gray-800">Мы - один из лучших салонов красоты в городе Рыбное</p>
        <p class="text-spacing-60">Наши клиенты ценят наш уровень обслуживания и профессиональный подход.</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="divider-lg"></div>
      ...
      <div class="col-sm-6 col-lg-4">
        <article class="box-icon-modern modern-variant-2">
          ...
          <h4 class="box-icon-modern-title"><a href="#">Стрижка &amp; Стиль</a></h4>
      ...
      <div class="col-sm-6 col-lg-4">
        <article class="box-icon-modern modern-variant-2">
          ...
          <h4 class="box-icon-modern-title"><a href="#">Макияж</a></h4>
          <div class="divider"></div>
      ...
      <div class="col-sm-6 col-lg-4">
        <article class="box-icon-modern modern-variant-2">
          ...
          <h4 class="box-icon-modern-title"><a href="#">Маникюр &amp; Педикюр</a></h4>
          <div class="divider"></div>
      ...
      <div class="col-sm-6 col-lg-4">
        <article class="box-icon-modern modern-variant-2">
          ...
          <h4 class="box-icon-modern-title"><a href="#">Забота о коже</a></h4>
          <div class="divider"></div>
      ...
      <div class="col-sm-6 col-lg-4">
        <article class="box-icon-modern modern-variant-2">
          ...
          <h4 class="box-icon-modern-title"><a href="#">Уход за телом</a></h4>
          <div class="divider"></div>
      ...
      <div class="col-sm-6 col-lg-4">
        <article class="box-icon-modern modern-variant-2">
          ...
          <h4 class="box-icon-modern-title"><a href="#">Массаж</a></h4>
          <div class="divider"></div>
      ...
      <div class="col-lg-6">
        <div class="row row-50">
          <div class="col-md-6 col-lg-12">
            <h2 class="heading-decorate"><span class="divider"></span>Наш салон красоты</h2>
            <p class="big text-gray-800">Мы ждем Вас! Приходите, мы уверены - Вам понравится!</p>
            <p></p>
          </div>
          <div class="col-md-6 col-lg-12">
            <div class="quote-with-image">
              ...
              <div class="quote-caption">
                ...
                <h3 class="quote-text">Мы несем ответственность за качество предоставляемых косметических услуг!</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="row row-50">
          <div class="col-md-6 col-lg-12">
            ...
            <p class="big text-gray-800">Мы предлагаем нашим клиентам самые современные материалы и услуги красоты, от нашего партнера ESTEL Professional! </p>
          </div>
          <div class="col-md-6 col-lg-12">
            <div class="box-video" data-lightgallery="group"><img src="images/home-1-9-541x369.jpg" alt="" width="541" height="369"/>
            </div>
          </div>
        </div>
      </div>
...
<section class="section section-lg bg-default">
  <div class="container">
    <div class="row row-50">
      <div class="col-lg-6">
        <div class="block-xs">
          <h2 class="heading-decorate">Отзывы<br class="d-inline"><span class="divider"></span>наших клиентов</h2>
          <p class="big text-gray-800">Благодаря отзывам и комментариям от наших клиентов мы улучшаем наш сервис!</p>
          <p>Мы поддерживаем постоянную связь с нашими клиентами и с нетерпением ждем отзывов о каждой услуге. Если вы уже посетили салон красоты Елена, свяжитесь с нами и оставьте свой отзыв!</p>
        </div>
      </div>
      <div class="col-lg-6">
        <!-- Owl Carousel-->
        <div class="owl-carousel carousel-corporate" data-items="1" data-dots="true" data-nav="false" data-stage-padding="10px" data-loop="false" data-margin="25px" data-mouse-drag="false">
          <div class="quote-corporate">
            <div class="quote-header">
              <h4>Александра Т.</h4>
              <p class="big">Клиент</p>
            </div>
            <div class="quote-body">
              <div class="quote-text">
                <p>Спасибо за прекрасную работу, которую вы проделали. Я буду рекомендовать вас своим друзьям!</p>
              </div>
          ...
          <div class="quote-corporate">
            ...
            <div class="quote-body">
              <div class="quote-text">
                <p>Если вы все ещё ищете, где лучше всего подстричься, отправляйтесь в салон Елена!</p>
              </div>
              <svg class="quote-body-mark" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="66px" height="49px" viewbox="0 0 66 49" enable-background="new 0 0 66 49" xml:space="preserve">
                <g></g>
                <path d="M36.903,49v-3.098c9.203-5.315,14.885-12.055,17.042-20.222c-2.335,1.524-4.459,2.288-6.37,2.288						c-3.186,0-5.875-1.29-8.071-3.876c-2.194-2.583-3.293-5.74-3.293-9.479c0-4.133,1.443-7.605,4.327-10.407						C43.425,1.405,46.973,0,51.185,0c4.213,0,7.735,1.784,10.566,5.352C64.585,8.919,66,13.359,66,18.669						c0,7.482-2.85,14.183-8.549,20.112C51.751,44.706,44.902,48.112,36.903,49z M0.69,49v-3.098						c9.205-5.315,14.887-12.055,17.044-20.222c-2.335,1.524-4.478,2.288-6.423,2.288c-3.152,0-5.823-1.29-8.02-3.876						C1.096,21.51,0,18.353,0,14.614c0-4.133,1.434-7.605,4.301-10.407C7.168,1.405,10.709,0,14.92,0c4.247,0,7.778,1.784,10.592,5.352						c2.814,3.567,4.223,8.007,4.223,13.317c0,7.482-2.843,14.183-8.524,20.112C15.53,44.706,8.69,48.112,0.69,49z"></path>
          ...
          <div class="quote-corporate">
            ...
            <div class="quote-body">
              <div class="quote-text">
                <p>Я очень довольна результатом. Мне повезло, что я встретила мастера с многолетним опытом в макияже!</p>
              </div>
              <svg class="quote-body-mark" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="66px" height="49px" viewbox="0 0 66 49" enable-background="new 0 0 66 49" xml:space="preserve">
                <g></g>
                <path d="M36.903,49v-3.098c9.203-5.315,14.885-12.055,17.042-20.222c-2.335,1.524-4.459,2.288-6.37,2.288						c-3.186,0-5.875-1.29-8.071-3.876c-2.194-2.583-3.293-5.74-3.293-9.479c0-4.133,1.443-7.605,4.327-10.407						C43.425,1.405,46.973,0,51.185,0c4.213,0,7.735,1.784,10.566,5.352C64.585,8.919,66,13.359,66,18.669						c0,7.482-2.85,14.183-8.549,20.112C51.751,44.706,44.902,48.112,36.903,49z M0.69,49v-3.098						c9.205-5.315,14.887-12.055,17.044-20.222c-2.335,1.524-4.478,2.288-6.423,2.288c-3.152,0-5.823-1.29-8.02-3.876						C1.096,21.51,0,18.353,0,14.614c0-4.133,1.434-7.605,4.301-10.407C7.168,1.405,10.709,0,14.92,0c4.247,0,7.778,1.784,10.592,5.352						c2.814,3.567,4.223,8.007,4.223,13.317c0,7.482-2.843,14.183-8.524,20.112C15.53,44.706,8.69,48.112,0.69,49z"></path>
